...
static const _CompressedMsg_type_support_symbol_names_t _CompressedMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, domain_bridge, msg, CompressedMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, domain_bridge, msg, CompressedMsg)),
  }
};
...
{
  return &::domain_bridge::msg::rosidl_typesupport_cpp::CompressedMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, domain_bridge, msg, CompressedMsg)() {
  return get_message_type_support_handle<domain_bridge::msg::CompressedMsg>();
}
