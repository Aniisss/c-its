...
#define NODE_MAIN_LOGGER_NAME "test_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdomain_bridge_test_component_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<domain_bridge::TestComponent>";
